...
residuo_w <- (dados$TEMPO*exp(-ajuste_w$coefficients[1]                           - ajuste_w$coefficients[2]*dados$SEXO))^(1/ajuste_w$scale)
...
### tempo medio 
# sexo masculino
exp(ajuste_ln$coefficients[1] + ajuste_ln$scale^2/2) 

# sexo feminino 
exp(ajuste_ln$coefficients[1] + ajuste_ln$coefficients[2] + ajuste_ln$scale^2/2) 
```
